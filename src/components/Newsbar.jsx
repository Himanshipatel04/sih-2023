...
const Newsbar = () => {
  return (
    <div className=" h-[80vh] w-[30%] bg-[#2dc4c7] rounded-xl p-4 flex justify-center items-center sticky top-24 flex-col gap-12">
      <div className="cursor-pointer h-36 w-full rounded-md p-4 flex gap-2 hover:outline outline-1 duration-200">
        ...
        <div>
          ...
          <p className=" text-white text-xs ">
            ...
            beatae modi, natus consequuntur amet aperiam reprehenderit velit
            sit. Voluptatem qui suscipit ducimus, veritatis id laborum.
          </p>
          <button className=" text-sm text-blue-800 underline">see project</button>
        </div>
      </div>
      <div className=" cursor-pointer h-36 w-full rounded-md p-4 flex gap-2 hover:outline outline-1 duration-200">
      ...
      <div className=" cursor-pointer h-36 w-full rounded-md p-4 flex gap-2 hover:outline outline-1 duration-200">
        ...
        <div>
          ...
          <button className=" text-sm text-blue-800 underline">see projects</button>
        </div>
      </div>
      <div className="cursor-pointer h-36 w-full rounded-md p-4 flex gap-4 hover:outline outline-1 duration-200">
